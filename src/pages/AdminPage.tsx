...
const TILES: Tile[] = [
  ...
  { key: 'stock',  label: 'Estoque',      icon: Package,         to: '/marketplace?tab=stock' },
  { key: 'promo',  label: 'Promoções',    icon: Tag,             to: '/promos' },
  { key: 'rate',   label: 'Avaliações',   icon: Star,            to: '/clients?filter=ratings' },
  ...
  { key: 'team',   label: 'Equipe',       icon: UserCog,         to: '/ceo?tab=team' },
  { key: 'units',  label: 'Unidades',     icon: Building2,       to: '/ceo?tab=units' },
