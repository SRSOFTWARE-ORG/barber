...
const BASE_URL = "https://barber.srsoftwarestore.com";
...
// Only public, indexable routes (no admin/per-user data or transactional pages).
const entries: SitemapEntry[] = [
  { path: "/", changefreq: "weekly", priority: "1.0" },
  { path: "/auth", changefreq: "monthly", priority: "0.7" },
  { path: "/services", changefreq: "weekly", priority: "0.8" },
  { path: "/gallery", changefreq: "weekly", priority: "0.8" },
  { path: "/promos", changefreq: "weekly", priority: "0.7" },
